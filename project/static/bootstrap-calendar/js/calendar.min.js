    ...
    function(t) {
        ...
        function a(e, a) {
            var o = null != e.options[a] ? e.options[a] : null,
                n = null != e.locale[a] ? e.locale[a] : null;
        ...
        function o(e, i) {
            ...
            return t.each(l, function(e, a) {
                ...
                if (t.each(e.split(">"), function(t, a) {
                        var d, h = null;
                        if (d = /^(\d\d)-(\d\d)$/.exec(a)) h = new Date(i, parseInt(d[2], 10) - 1, parseInt(d[1], 10));
                        else if (d = /^(\d\d)-(\d\d)-(\d\d\d\d)$/.exec(a)) parseInt(d[3], 10) == i && (h = new Date(i, parseInt(d[2], 10) - 1, parseInt(d[1], 10)));
                        else if (d = /^easter(([+\-])(\d+))?$/.exec(a)) h = r(i, d[1] ? parseInt(d[1], 10) : 0);
        ...
        function s(e, a, o, n) {
            e.stopPropagation();
            var a = t(a),
                i = a.closest(".cal-cell"),
                s = i.closest(".cal-before-eventlist"),
                r = i.data("cal-row");
        ...
        o.cache = {}, i.prototype.setOptions = function(e) {
            ...
            var d = e.hours * i - parseInt(r[1]) / o,
                h = 6e4 * o,
            ...
            c.setHours(l[0]), c.setMinutes(l[1]), e.all_day = [], e.by_hour = [], e.after_time = [], e.before_time = [], t.each(e.events, function(t, o) {
                var i = new Date(parseInt(o.start)),
            ...
            var n = {
                ...
                i = this.options.classes.months.outmonth,
            ...
            switch (t.type(o)) {
                ...
                case "string":
                    o.length && (i = function() {
                        var n = [],
                            i = {
                                from: a.options.position.start.getTime(),
                                to: a.options.position.end.getTime()
                            };
                ...
                if (a.length) {
                    ...
                    "iframe" == e.options.modal_type && (o = t(document.createElement("iframe")).attr({
                        ...
                        var i = t(this).attr("href"),
                            ...
                            n = _.find(e.options.events, function(t) {
                                return t.id == s
                            });
        ...
        }, i.prototype._update_week = function() {}, i.prototype._update_year = function() {
            this._update_month_year()
        }, i.prototype._update_month = function() {
            this._update_month_year();
            var e = this,
                a = t(document.createElement("div")).attr("id", "cal-week-box"),
                o = this.options.position.start.getFullYear() + "-" + this.options.position.start.getMonthFormatted() + "-";
            t(".cal-month-box .cal-row-fluid").on("mouseenter", function() {
                var n = new Date(e.options.position.start),
                    i = t(".cal-cell1:first-child .cal-month-day", this),
                    s = i.hasClass("cal-month-first-row") ? 1 : t("[data-cal-date]", i).text();
            ...
            if (this.options.views[this.options.view].slide_events) {
                var e = this,
                    a = t(document.createElement("div")).attr("id", "cal-day-tick").html('<i class="icon-chevron-down"></i>');
